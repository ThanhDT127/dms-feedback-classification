...
for r in rows:
    ...
    if row_num == 3:  # Text: nan
        ...
        row_num == 4
    ):  # Giá được quay cao hơn giá trần nhiều,nếu quay giải 4,5 là cửa hàng bị lỗ
        better = "V3"
        ...
        row_num == 24
    ):  # Cp12 vỏ hộp xộc xệch, mỏng, không chắc chắn,cty làm vỏ hộp dày dặn hơn
        better = "Old"
        ...
        row_num == 28
    ):  # Cải tiến led dây.người tiêu dùng thích loại led dây có 3 hàng mắt led
        better = "V3"
        ...
        row_num == 34
    ):  # Đèn năng lượng mặt trời cp03v2 dòng pin hiệu suất cao pin dùng được lâu hơn
        better = "V3"
        ...
        error_group = (
            "Nhầm lẫn nhãn và sentiment của Tin trung lập thành Tốt/ko tốt tiêu cực"
        )
        ...
        row_num == 40
    ):  # CH lấy Tùng Gia Phát đủ loại nhưng ko cho công nợ lâu như mình
        better = "V3"
        ...
        row_num == 45
    ):  # Át nổi HB 2P1E lên làm thêm cả đèn báo giống như hãng Điện Quang.
        better = "V3"
        ...
        row_num == 48
    ):  # ổ chịu tải lên làm thêm mầu cam giống hãng Sofoka và Vinakip dễ bán hơn.
        better = "V3"
        ...
        row_num == 53
    ):  # Bóng led trụ 30w ĐQ khách nhập thùng giá 108k tặng 2sp cùng loại .
        better = "V3"
        ...
        row_num == 54
    ):  # Khách xin caâtloge để kham khảo sản phẩm mong muốn bán hàng RĐ
        better = "V3"
        ...
        row_num == 56
    ):  # Ổ cắm sopoka mẫu đẹp, đa dạng, chất lượng tốt nên khách hay lựa chọn mua loại này
        better = "V3"
        ...
        row_num == 81
    ):  # OC10 làm thêm loại 4,5,6 chân cắm. Logo in màu khác thân vỏ dễ nhận diện thương hiệu. Làm thêm màu cho khách chọn lựa.
        better = "Tranh luận"
        ...
        row_num == 92
    ):  # Giá bộ bán nguyệt,âm trần bên nhà buôn Hưng Yên bán thấp hơn nhập Thái Bình
        better = "V3"
        ...
        row_num == 96
    ):  # KH phản hồi cty nên làm thêm tủ điện nhựa cửa quay, cánh trắng hoặc in tranh đều đẹp. Sản lượng bán tốt
        better = "V3"
        ...
        row_num == 100
    ):  # Ổ cắm chịu tải ra thêm loại 2-4. Phích cắm cần làm mỏng đi 1chút
        better = "V3"
        ...
        row_num == 102
    ):  # mẫu Ốp trần ln30 xấu không đẹp, ln12 đẹp phổ thông đễ bán , mã mới rất khó vào
        better = "V3"
        ...
        row_num == 108
    ):  # Tấm pin chiếu pha NLMT 200w và 300w khác chê tấm pin đợt này nhỏ họ không yên tâm
        better = "V3"
        ...
        row_num == 110
    ):  # Attomat giờ khách hàng đang quen với sino và pannal nên giờ rạng đông ra rất khó vào thị trường!
        better = "V3"
        ...
        row_num == 111
    ):  # vỏ hộp bulb trụ 20w-30w mỏng quá, xếp hay bị văng,tụt sản phẩm ra ngoài.
        better = "V3"
        ...
        row_num == 117
    ):  # Khách vẫn thích dùng máng vs tube hơn bóng led ctrinh quay số khách ko lấy được nhiều
        better = "V3"
        ...
        row_num == 120
    ):  # Sản phẩm led rạng đông chất lượng tốt ít khi bị lỗi phải bảo hành
        better = "V3"
        ...
        row_num == 125
    ):  # Ấm siêu tốc của Trung Quốc giá thành rẻ nên khách hay lựa chọn mua loại này
        better = "Tranh luận"
        ...
        row_num == 129
    ):  # oc10 mẫu mã và màu xấu hơn các thương hiệu khác như Sopoka hay Omisu
        better = "V3"
        ...
        row_num == 145
    ):  # Cty câp Giơ-le nhiệt để cửa hàng chủ động thay thế , đỡ mất công đổi mới nó lãng phí cho cty
        better = "V3"
        ...
        row_num == 150
    ):  # Ống nhựa tiền phong thay 100% biển mới cho khách hàng mặc dù chưa hỏng hay cũ vẫn thay mới
        better = "V3"
        ...
        row_num == 152
    ):  # Cty nên cải tiến mặt của tủ át TAT01 loại tủ nhựa nên lm dầy lên chứ thấy mỏng manh quá
        better = "V3"
        ...
        row_num == 158
    ):  # Ấm siêu tốc st3 1.8l sản xuất tháng 6/2025 khi nước sôi tự bật nắp lên.
        better = "V3"
        ...
        row_num == 160
    ):  # Mưa bảo biển bảng bay hết mong CTy làm chương trình biển bảng cho đại lý
        better = "V3"
        ...
        row_num == 170
    ):  # Ốp trần bán trậm, ln12n vẫn còn nhiều, ốp ln29,30 mẫu không đẹp lắm lên không nhập
        better = "V3"
        ...
        row_num == 172
    ):  # Ổ chịu tải và ổ liền dây o5. 06 làm thêm màn tre cho an toàn điện
        better = "V3"
        ...
        row_num == 178
    ):  # Mong muốn cty ra chương trình hỗ trợ biển bảng , kê trưng bày
        better = "Tranh luận"
        ...
        row_num == 186
    ):  # Calisun có chương trình tặng xe thể thao cho khách khi tham gia gói sản phẩm 35 triệu
        better = "V3"
        ...
        row_num == 187
    ):  # Không lấy m26 vì có cửa hàng gần đó bán ra cho ng dùng cuối giá 118
        better = "V3"
        ...
        row_num == 188
    ):  # Attomat đen cần làm thêm đèn,màu sắc đen trông không đẹp như sino
        better = "V3"
        ...
        row_num == 194
    ):  # M26 50w Ngọc Huy trừ hết giá cho CH còn 118k, Ngọc Hiếu trừ còn 115k
        better = "V3"
        ...
        row_num == 210
    ):  # phích cắm chịu tải lên đóng thành dây 10 cái /1 dây, treo dễ trưng bày và dễ khi bán hàng.
        better = "Tranh luận"
        reason = "Cả hai đều gán đúng 'Y/c cải tiến'. V3 tốt hơn về sentiment trung lập so với Tiêu cực của Old."
        error_group = "Lỗi gán sai Sentiment (Tiêu cực hóa phản hồi trung lập)"
    elif (
        row_num == 211
    ):  # Cty ra thêm mẫu ốp trang trí đổi màu phục vụ nhu cầu của người dùng
        better = "Tranh luận"
        ...
        row_num == 219
    ):  # Hãng DUHAL giá rẻ, CH nhập số lượng lớn trụ với bán nguyệt, túyp
        better = "V3"
        ...
        row_num == 230
    ):  # led bulb trụ công suất lớn 60w 60k rẻ quá. Rạng Đông gần 200k đắt khó bán.
        better = "V3"
        ...
        row_num == 231
    ):  # Welmax đóng hàng đèn NLMT khá gọn, đc bọc trong màng co, dễ vận chuyển
        better = "V3"
        ...
        row_num == 237
    ):  # Ch hữu hoàng. Ruột 2 lít cô bị lỗi 4 cái giữ nhiệt kém 4 tiếng đã nguội
        better = "V3"
        ...
        row_num == 250
    ):  # bộ đèn m36 ( 241113130004A) lỗi không sáng, thời gian sử dụng 6 tháng
        better = "V3"
...
with open(
    "D:\\Works\\DMS\\scratch\\evaluated_results.json", "w", encoding="utf-8"
) as f:
