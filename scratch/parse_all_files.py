...
print(f"File 1: Identical={id1}, Diff Label={dl1}, Diff Sentiment={ds1}, Diff Both={db1}")
print(f"File 2: Identical={id2}, Diff Label={dl2}, Diff Sentiment={ds2}, Diff Both={db2}")
